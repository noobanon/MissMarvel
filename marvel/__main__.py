...
from marvel import dispatcher, updater, TOKEN, WEBHOOK, SUDO_USERS, OWNER_ID, CERT_PATH, PORT, URL, LOGGER, \
    ALLOW_EXCL
...
from marvel.modules.translations.strings import tld, tld_help
...
def start(bot: Bot, update: Update, args: List[str]):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Yo'wtsup")
...
def control_panel(bot, update):
    ...
    if query:
        ...
        M_match = "Ultron is Danger af 🔥" #LMAO, don't uncomment
