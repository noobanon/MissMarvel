...
BL_HANDLER = CommandHandler("bl", bl_user, pass_args=True, filters=Filters.user(OWNER_ID))
UNBL_HANDLER = CommandHandler("unbl", unbl_user, pass_args=True, filters=Filters.user(OWNER_ID))
