...
from marvel.modules.helper_funcs.chat_status import bot_admin, can_promote, user_admin, can_pin
...
def promote(bot: Bot, update: Update, args: List[str]) -> str:
	...
	if user_member.can_promote_members == False:
    	    message.reply_text("You are missing the following rights to use this command:CanPromoteMember!")
    	    return ""
...
def demote(bot: Bot, update: Update, args: List[str]) -> str:
    ...
    user_member = chat.get_member(user.id)
	if user_member.can_promote_members == False:
    	    message.reply_text("You are missing the following rights to use this command:CanDemoteMember!")
    	    return ""
    conn = connected(bot, update, chat, user.id)
    if not conn == False:
        chatD = dispatcher.bot.getChat(conn)
...
def pin(bot: Bot, update: Update, args: List[str]) -> str:
	...
	if user_member.can_pin_messages == False:
    	    message.reply_text("You are missing the following rights to use this command:CanPin!")
    	    return ""
